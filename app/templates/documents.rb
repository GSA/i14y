...
class Documents
  include Templatable
  LIGHT_STEMMERS = { fr: 'french', de: 'german', es: 'spanish', it: 'italian', pt: 'portuguese' }.freeze
  STANDARD_STEMMERS = { en: 'english', fi: 'finnish', hu: 'hungarian', ru: 'russian', sv: 'swedish' }.freeze
